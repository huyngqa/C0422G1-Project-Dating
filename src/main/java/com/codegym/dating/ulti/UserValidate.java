...
public class UserValidate {
    ...
    static public void checkAge(UserDto userDto, Errors errors) {
    ...
    static public void checkHobbit(UserDto userDto, Errors errors) {

        if (userDto.getUserHobbits().isEmpty()) {
    ...
    static public void checkTarget(UserDto userDto, Errors errors) {

        if (userDto.getUserTargets().isEmpty()) {
