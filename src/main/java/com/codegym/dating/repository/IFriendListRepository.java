...
public interface IFriendListRepository extends JpaRepository<FriendList, Integer> {
    ...
    RelationshipDto findRelationship(Integer idUser1, Integer idUser2);

    @Modifying
    @Query(value = "INSERT INTO `dating_c04`.`friend_list` (`status`, `id_user1`, `id_user2`)\n" +
            " VALUES ('5', ?1, ?2)", nativeQuery = true)
